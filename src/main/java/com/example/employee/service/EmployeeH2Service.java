...
public class EmployeeH2Service implements EmployeeRepository {
    ...
    public Employee addEmp(Employee employee) {
        db.update("INSERT INTO EMPLOYEELIST (employeeName, email, department) VALUES(?,?,?)", employee.getEmpName(),
    ...
    public Employee updateEmp(int empId, Employee employee) {
        if (empMap.containsKey(empId)) {
            Employee existingEmployee = empMap.get(empId);
            ...
            empMap.put(empId, existingEmployee);
